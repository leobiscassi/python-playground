...
def main(location, api_key):
    """
    A little weather tool that shows you the current weather in a LOCATION
    ...
    You need a valida API key from OpenWeatherMap for the tool to work.
    You sign up for a free account at https:// openweathermap.org/appid.
    """
